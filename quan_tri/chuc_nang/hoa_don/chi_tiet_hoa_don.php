...
<?php
	include('../connect.php');
	$id= $_GET['id'];
	$sl="select * from hoa_don where id=".$id;
...
<table>
	...
	<tr>
		...
		<td><a style="text-decoration: none; padding: 5px 15px; background-color: #1D388F; color: #fffafa;" href="?menu=xu_ly&id=<?php echo $row['id']; ?>">Duyệt</a></td>
		<td><a style="text-decoration: none; padding: 5px 15px; background-color: #1D388F; color: #fffafa;" href="?menu=da_xem&id=<?php echo $row['id']; ?>">Đã xem</a></td>
		<td><a style="text-decoration: none; padding: 5px 15px; background-color: #1D388F; color: #fffafa;"  onclick="return confirm('Bạn có mún xóa hóa đơn?');"  href="?menu=xoa&id=<?php echo $row['id']; ?>">Xóa hóa đơn</a></td>
	</tr>
</table>