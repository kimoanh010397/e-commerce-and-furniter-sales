<?php
	...
	$old_password=md5($old_password);
	$sql= "select * from tai_khoan where password='".$old_password."' and username='".$_SESSION['username']."'";
	...
	$sl="update tai_khoan set password='".$password."' where username='".$_SESSION['username']."'";
