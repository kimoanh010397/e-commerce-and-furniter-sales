...
<div class="panel panel-primary">
    ...
    <p class="alert alert-warning"><strong>Lưu ý: </strong>Các thông tin đều là bắt buộc.</p>
	...
	<table class="table">
		...
		<tr>
			<td><label for="tinhtp">Tỉnh/TP:</label></td>
			<td>
		...
		<tr>
			<td><label for="quanhuyen">Quận/Huyện:</label></td>
			<td>
		...
		<tr>
			<td><label for="xaphuong">Xã/phường: </label></td>
			<td>
