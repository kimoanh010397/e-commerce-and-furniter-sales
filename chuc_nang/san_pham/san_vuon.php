<script type="text/javascript">
    ...
    $(document).ready(function() {
        document.title = 'Nội thất sân vườn';
    });

</script>
<div class="panel panel-primary">
      <div class="panel-heading">Nội thất sân vườn</div>
...
<?php
	...
	$page=$page-1;
	$limit= 12;
	$sql="select * from san_pham where ma_nhom like 'san_vuon'";
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="product">
		<?php
	$sl= "select * from san_pham where ma_nhom like 'san_vuon' limit ".$start.",".$limit;
