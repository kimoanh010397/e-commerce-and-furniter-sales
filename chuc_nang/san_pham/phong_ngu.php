<script type="text/javascript">
    ...
    $(document).ready(function() {
        document.title = 'Nội thất phòng ngủ';
    });
...
<?php
	...
	$page=$page-1;
	$limit= 12;
	$sql="select * from san_pham where ma_nhom like 'phong_ngu'";
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="product">
		<?php
	$sl= "select * from san_pham where ma_nhom like 'phong_ngu' limit ".$start.",".$limit;
